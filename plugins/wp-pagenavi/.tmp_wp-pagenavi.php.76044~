...
//	}
    ...
    if (function_exists('add_submenu_page')) {
        ...
        add_submenu_page('wp_plugins.php', 'PaveNavi Options', 'PageNavi Options', 8, 'pagenavi/' . basename(__FILE__), 'pagenavi/pagenavi-options.php');
...
function pagenavi_css() {
	...
	echo '<link rel="stylesheet" href="'.get_stylesheet_directory_uri().'/plugins/pagenavi/pagenavi-css.css" type="text/css" media="screen" />'."\n";	
...
function pagenavi_init() {
    ...
    fwrite($fh, date("M-d-Y g:i:s", mktime()) . ": PageNav Before AddSubmenu\n" );
	//add_submenu_page('wp_plugins.php', 'PageNavi Options', 'PageNavi Options', 9, basename(__FILE__), array($this, 'pagenavi_options'));
        add_submenu_page('wp_plugins.php', 'PaveNavi Options', 'PageNavi Options', 8, basename(__FILE__), 'pagenavi/pagenavi-options.php');
