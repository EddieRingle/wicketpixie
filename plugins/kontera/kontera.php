...
?>
	...
	<script src="<?php echo get_bloginfo('template_directory'); ?>/plugins/kontera/palette.js" type="text/javascript"></script>
	<link href="<?php echo get_bloginfo('template_directory'); ?>/plugins/kontera/palette.css" media="screen" rel="stylesheet" type="text/css" />
	<tr>
		<td>
		...
		<td>
			<div style='width:30' id="color_preview_wrapper">
				<img id="pal_img" src="<?php echo get_bloginfo('template_directory'); ?>/plugins/kontera/pal.gif" width="16" height="16" alt="Open Palette" onclick="openPalette('color_preview')"/>
			</div>
...
?>
	...
	<img src="<?php echo get_bloginfo('template_directory'); ?>/plugins/kontera/pal_cancel.gif" border="0" width="48" height="15" style="float:left; padding: 5px 0 0 8px;"    onclick="pal_reset()" />
	<img src="<?php echo get_bloginfo('template_directory'); ?>/plugins/kontera/pal_ok.gif" border="0" width="48" height="15" style="float:right;  padding: 5px 8px 0 0;" onclick="setVal()"/>
