...
class All_in_One_SEO_Pack {
	...
	function init() {
		if (function_exists('load_plugin_textdomain')) {
			load_plugin_textdomain('all_in_one_seo_pack', '/wp-content/themes/'.get_template().'/plugins/all-in-one-seo-pack');
		}
	}
	...
	function admin_head() {
		...
		$stylesheet = $home.'/wp-content/themes/'.get_template().'/plugins' . $this->get_base() . '/css/all_in_one_seo_pack.css';
	...
	function admin_menu() {
		...
		add_submenu_page('wipi-plugins.php', __('All in One SEO', 'all_in_one_seo_pack'), __('All in One SEO', 'all_in_one_seo_pack'), 10, basename(__FILE__), array($this, 'options_panel'));
	}
